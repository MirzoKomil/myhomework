...
function buildGrammarHomework(offset: number): HomeworkPart[] {
  return [
    ...
    { id: 'B', kind: 'fillBlank', title: 'PART B — Fill in the blank', blanks: pickWindow(GRAMMAR_POOL, offset, 5) },
    { id: 'C', kind: 'multipleChoice', title: 'PART C — Multiple choice', questions: pickWindow(MC_POOL, offset, 5) },
    { id: 'D', kind: 'sentenceBuild', title: 'PART D — Sentence building', items: pickWindow(SENTENCE_POOL, offset, 4) },
